import uuid
import os
from helper import get_pdf_paths, read_uploaded_file, extract_data_analysis, folder_id
...
job = database.get_job_by_name('Vaga de ...')

# Inicializar o cliente de IA para processar os currículos
ai = GroqClient()

base_dir = os.path.join("curriculos", folder_id)
...
cv_paths = get_pdf_paths(base_dir)
